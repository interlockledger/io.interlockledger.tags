...
public interface ILTagDataReader {
	...
	/**
	 * Returns the number of bytes remaining if a limit is on effect. If the limit
	 * is not set, the return of this method is undefined.
	 * 
	 ...
	 * 
	 * @param checkRemaining If true, this method will fail if the limit was not
	 *                       achieved.
	...
	/**
	 * Imposes a limit to the number of bytes that can be read without a read error.
	 * Multiple calls to this method will stack the limits, allowing multiple sub
	 * limits to be defined.
	 * 
	 * <p>
	 * Limits defined by this method may be removed by calls of popLimit(boolean).
	 * </p>
	 * 
	...
	/**
	 * Reads a 64-bit single precision floating point in IEEE 754-2008 format.
	 * 
	...
	/**
	 * Reads a 32-bit single precision floating point in IEEE 754-2008 format.
	 * 
	 * @return The value read.
	 * @throws ILTagException In case of error.
	 */
