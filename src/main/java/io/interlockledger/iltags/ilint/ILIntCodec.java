...
public class ILIntCodec {
	...
	/**
	 * Interface of the byte input handler. All instances of this interface must be
	 * thread safe.
	 */
	...
	/**
	 * Interface of the byte output handler. All instances of this interface must be
	 * thread safe.
	 */
	...
	/**
	 * LInt base value. All values larger then or equal to will use more than 1 byte
	 * to be encoded.
	 */
